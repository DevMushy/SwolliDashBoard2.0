...
<center><h4>Agenda Pagamenti</h4>
  <h6>Lista dei pagamenti divisi per giorno</h6></center>
    <?php

      $select = "SELECT * FROM data WHERE ID_userData = '$userID' ORDER BY date DESC, time DESC";
